...
// ═══════════════════════════════════════════════
import { addDays, callFn, COMMON_RULES, dow, num, pct, reportSchema, Row, safeCollector, AgentDef } from "../_shared/agent.ts";
...
export const DEF: AgentDef = { agent: AGENT, label: "매출 분석 담당", system: SYSTEM, schema: SCHEMA, collect };
